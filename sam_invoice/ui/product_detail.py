"""Product detail widget using the base class."""
...
class ProductDetailWidget(BaseDetailWidget):
    """Product detail widget with view/edit mode.

    Displays product information (reference, name, price, stock, sold)
    ...
    def __init__(self, parent=None):
        ...
        self.product_saved = self.item_saved
        self.product_deleted = self.item_deleted
        ...
        # Load icon
        self._load_avatar_icon("products")
    ...
    def _save_changes(self):
        ...
        self.product_saved.emit(data)
        self._enter_edit_mode(False)

    def _on_delete_clicked(self):
        """Ask for confirmation and delete the product."""
        ...
        res = QMessageBox.question(
            self,
            "Delete",
            f"Delete product '{reference}'? This action cannot be undone.",
            QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No,
        )

        if res == QMessageBox.StandardButton.Yes:
            self.product_deleted.emit(int(self._current_id))
    ...
    def set_product(self, art):
        ...
        if not art:
            ...
            # Display product data with formatting
